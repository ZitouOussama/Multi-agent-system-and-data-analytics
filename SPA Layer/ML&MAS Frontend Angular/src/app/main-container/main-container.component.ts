...
export class MainContainerComponent implements OnInit {
  ...
  CalculCases(){
    //console.log(this.dataMaroc.statistics[0])
    this.nDeaths=this.dataMaroc.statistics[0]['Deaths/الوفيات'];
    this.nCured=this.dataMaroc.statistics[0]['Recovered/تعافى'];
    this.nCases=this.dataMaroc.statistics[0]['Cases/الحالات'];
